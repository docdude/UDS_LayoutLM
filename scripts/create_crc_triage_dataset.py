"""Create training dataset from CRC triage Label Studio export."""
import json
import os
import sys
...
# Use the new CRC triage labels
from src.labels_crc_triage import LABEL2ID, ID2LABEL, NUM_LABELS
...
def main():
    ...
    images_dir = "data/processed/crc_triage"
    output_dir = "data/dataset_crc_triage_v4"
    
    print("=" * 50)
    print("Creating CRC Triage Training Dataset")
    print("=" * 50)
